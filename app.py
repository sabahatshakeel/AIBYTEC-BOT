...
# # Function to implement RAG with Chroma
# def generate_rag_qa(pdf_text, website_text):
...
# def chat_with_ai_rag(user_question, qa_chain):
#     try:
...
#     qa_chain = generate_rag_qa(pdf_text, website_text)
...
#             bot_response = chat_with_ai_rag(user_input, qa_chain)
